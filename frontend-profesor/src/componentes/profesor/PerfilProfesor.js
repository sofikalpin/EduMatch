...
import HeaderForo from '../vistaProfesor/HeaderProfesor';
...
const PersonalDataForm = () => {
  ...
  const handleLogout = () => {
    // Aquí podrías agregar la lógica de cierre de sesión, como borrar tokens, etc.
      ...
      <div className="flex-grow p-8 max-w-5xl mx-auto w-full mb-6 mt-6">
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="bg-red-600 text-white px-6 py-3 rounded-full text-lg hover:bg-red-700 transition-colors text-center"
          >
            Cerrar sesión
          </button>
        </div>
