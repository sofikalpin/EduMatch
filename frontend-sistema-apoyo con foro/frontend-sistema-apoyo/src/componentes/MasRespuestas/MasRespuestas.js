...
import logo from '../../logo/LogoInicio.png'; // Asegúrate de que la ruta sea correcta
import { API_BASE_URL } from '../../config/api'; // Asegúrate de que la URL de la API sea correcta
