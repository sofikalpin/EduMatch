  ...
  const handleSubmit = async (e) => {
    ...
    if (await validateStep()) {
      ...
      try {
        ...
        // Creando el objeto exactamente como lo espera el backend
        const usuarioData = {
          idusuario: 0,
          ...
          tokenExpiracion: new Date().toISOString(), // formato ISO completo
          cvRuta: "string", // Agregar valor por defecto
          fotoRuta: "string" // Agregar campo faltante
        };
  
        console.log('Datos a enviar:', usuarioData); // Para debugging
