...
const NavItem = ({ id, Icon, text, isActive, onClick }) => (
  <div
    onClick={onClick}
    className={`flex items-center space-x-3 p-2 rounded-lg cursor-pointer ${isActive ? 'bg-blue-500 text-black' : 'text-gray-300'}`}
  >
...
const TerminosYCondiciones = () => (
  <div className="p-8 max-w-5xl mx-auto space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
      ...
      <div className="p-6 bg-white rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-gray-800">5. Inquietudes con EduMatch</h2>
        <p className="text-lg text-gray-700 mt-4">
          En caso de que tengas alguna pregunta o inquietud sobre estos términos, no dudes en ponerte en contacto con nosotros.
        </p>
      </div>
      <div className="p-6 bg-white rounded-lg shadow-lg">
